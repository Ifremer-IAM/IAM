...
BioEcoPar_stripe::BioEcoPar_stripe(List listInput /* object@input */, List listSpec /* object@specific */, List listStochastic /* object@stochastic */, List listScen/* object@scenario */,
...
// PROTECT(parOQD); //+1
FList = list["Fleet"];
effortIni = FList["nbds_f"];
effort1Ini = FList["effort1_f"];
...
list = listInput;
// list_copy = Rf_duplicate(list);
// FList_copy = list_copy["Fleet"];
