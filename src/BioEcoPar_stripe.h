...
class BioEcoPar_stripe
{
public: //normalement, selon les conventions,  les attributs doivent �tre "private"

typedef  double (BioEcoPar_stripe::*BEfn1)(double mult);
typedef  double (BioEcoPar_stripe::*BEfn1_F)(double *x);

//   INPUTS   ------------------

List    list;       //liste d'objets R constituant la donn�e entr�e du mod�le. Certaines variables seront remises � jour dans le cadre
...
NumericVector *effortIni, *effort1Ini;
...
// //    METHODES  ---------------
	...
	//constructeur
    BioEcoPar_stripe(List listInput, List listSpec, List listStochastic, List listScen,
                IntegerVector RecType1, IntegerVector RecType2, IntegerVector RecType3, IntegerVector Scenarii, /*SEXP Bootstrp, SEXP nbBootstrp , */ // TODO : remove unused arg
                IntegerVector GestInd, NumericVector mOth, NumericVector bounds, List TAC, NumericVector FBAR, List othSpSup, NumericVector effSup, IntegerVector GestParam, NumericVector EcoDcf,
                NumericVector persCalc, NumericVector dr, IntegerVector SRind, List listSR, List TypeSR, NumericVector mFM, List TACbyFL, List Ftarg, List W_Ftarg, List MeanRec_Ftarg,
                List parBHV, List parQEX,
                List tacCTRL, List stochPrice, IntegerVector updateE, List parOQD, int VERBOSE);
