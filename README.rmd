...
To install the released version of IAM from [https://gitlab.ifremer.fr/iam/iam](https://gitlab.ifremer.fr/iam/iam):
...
# You can install devlopment version with the ref option
remotes::install_git(
  url = "https://gitlab.ifremer.fr/iam/iam", 
  ref = "dev", 
  build_vignettes = TRUE # require rmakdown and knitr
)
```
...
For further information, multiple vignettes are available along with function help.

To access a vignette you can run this code locally<!-- or check them with provided links-->.
