...
all.equal(mod@outputSp, stripe@outputSp) # pas la meme longueur lol !!!
all.equal(mod@output, stripe@output) # pas la meme longueur lol !!!

names(stripe@output[! names(stripe@output) %in% names(mod@output)])
names(stripe@outputSp[! names(stripe@outputSp) %in% names(mod@outputSp)])
```
