---
title: |
  ![](IAM_hex.png){width=2.5in}  
  Utilisation IAM dans R
output:
  pdf_document:
    keep_tex: yes
...
statu_quo_tbl_Fbar <- IAM.format(IAM_out_1984, name = "Fbar", sim_name = "statu_quo", n = 1)
head(statu_quo_tbl_Fbar)
# Extraction de plusieurs variables
statu_quo_tbl_summary <- IAM.format(IAM_out_1984, name = "summary", sim_name = "statu_quo", n = 1)
...
statu_quo_tbl_summary %>%
  ...
  # discard( ~ n_distinct(.) == 1) %>% # Ligne optionnelle pour enlever les colonnes identiques.
