...
<!-- De manière générale une Gestion multiplicative impacte plus lentement le système. -->
...
IAM_argum_1984_TACnbv <- IAM.editArgs_Gest(
  ...
  espece = "COR", delay = 2, 
  # type = "+", bounds = c(1e4, -60, # on fixe -100 en borne inférieur car le maximum de navire est 60
  type = "x", bounds = c(1e7, -1), # on fixe -100 en borne inférieur car le maximum de navire est 60
