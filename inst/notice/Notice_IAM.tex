...
\label{lcdfm} & lcd_{f,m} & \text{\todo[fancyline]{missing E}} & Taxes de débarquements des rejets "sous taille" (en \% du CA) par flottille et métier & \text{\todo[fancyline]{missing unit}} &  \tabnl
...
\caption{Paramètres initiaux pour le module "Economique"}
    ...
    \begin{nTable}{0.05}{0.17}{0.09}{0.2}{0.1}{0.4}
        ...
        \frac{ Lref_{f,m\pref{Lrefm}} }{nbvIni\fm  \cdot nbTripIni\fm} \times \frac{1}{tripLgthIni\fm \cdot cnbIni\fm}  \text{\todo[fancyline]{missing refs !}} \tabnl
